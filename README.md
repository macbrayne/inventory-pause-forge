...
__Abilities__:
- Pause on Inventory / Pause on Creative Inventory / Pause on Death Screen / Pause on Game mode Switcher / Pause on Furnace / Pause on Crafting Table / Pause on Shulker Box:
